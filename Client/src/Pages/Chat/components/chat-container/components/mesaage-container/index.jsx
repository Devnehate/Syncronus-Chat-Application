...
const MessageContainer = () => {
        ...
        }
        {
          message.sender._id !== userInfo.id ? <div className="flex items-center justify-start gap-3">
            <Avatar className="h-8 w-8 rounded-full overflow-hidden">
              ...
              <AvatarFallback className={`uppercase h-8 w-8 md:w-48 md:h-48 text-lg border-[1px] flex items-center justify-center rounded-full ${getColor(message.sender.color)}`}>
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full">
      {renderMessages()}
      <div ref={scrollRef} />
      {
